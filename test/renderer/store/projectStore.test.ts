...
describe("projectStore", () => {
  ...
  it("should isolate a layer and restore all", () => {
    ...
    store.addProject({
      ...
      layers: [
        { id: "l1", name: "Layer 1", visible: true, type: "raster", locked: false, opacity: 100, x: 0, y: 0, width: 800, height: 600, blendMode: "source-over" },
        { id: "l2", name: "Layer 2", visible: true, type: "raster", locked: false, opacity: 100, x: 0, y: 0, width: 800, height: 600, blendMode: "source-over" },
        { id: "l3", name: "Layer 3", visible: true, type: "raster", locked: false, opacity: 100, x: 0, y: 0, width: 800, height: 600, blendMode: "source-over" },
      ],
      activeLayerId: "l1",
      selectedLayerIds: ["l1"],
      selection: { hasSelection: false, bounds: null },
  ...
  it("should convert layers to a smart object and rasterize it", async () => {
    ...
    store.addProject({
      ...
      height: 600,
      layers: [
        { id: "l1", name: "Layer 1", visible: true, type: "raster", locked: false, opacity: 100, x: 10, y: 10, width: 100, height: 100, blendMode: "source-over" },
        { id: "l2", name: "Layer 2", visible: true, type: "raster", locked: false, opacity: 100, x: 50, y: 50, width: 100, height: 100, blendMode: "source-over" },
      ],
      activeLayerId: "l1",
      selectedLayerIds: ["l1", "l2"],
      selection: { hasSelection: false, bounds: null },
  ...
  it("should remove multiple layers and their descendants", () => {
    ...
    store.addProject({
      ...
      height: 600,
      layers: [
        { id: "g1", name: "Group 1", type: "group", visible: true, locked: false, opacity: 100, x: 0, y: 0, width: 0, height: 0, blendMode: "source-over" },
        { id: "l1", name: "Layer 1", parentId: "g1", type: "raster", visible: true, locked: false, opacity: 100, x: 0, y: 0, width: 100, height: 100, blendMode: "source-over" },
        { id: "l2", name: "Layer 2", type: "raster", visible: true, locked: false, opacity: 100, x: 0, y: 0, width: 100, height: 100, blendMode: "source-over" },
        { id: "l3", name: "Layer 3", type: "raster", visible: true, locked: false, opacity: 100, x: 0, y: 0, width: 100, height: 100, blendMode: "source-over" },
      ],
      activeLayerId: "l3",
